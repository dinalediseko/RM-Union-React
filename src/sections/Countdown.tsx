...
export default function Countdown() {
  ...
  return (
    ...
    >
      {/* Heading */}
      <h2 className="font-script text-4xl text-orange mb-2">
        We say
      </h2>
      <p className="font-script text-3xl text-maroon mb-8">
        "I Do" in...
      </p>
      ...
      <div className="flex justify-center items-start gap-4 md:gap-6 mb-10">
        ...
        {/* Separator */}
        <div className="countdown-number text-maroon">:</div>
